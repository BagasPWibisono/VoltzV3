...
module.exports = {
  name: "search",
  description: "cari lagu yang sesuai via Youtube",
  category: "MUSIC",
...
async function search({ member, guild, channel }, query) {
  if (!member.voice.channel) return "🚫 Join voice channel terlebih dahulu";
  ...
  if (player && member.voice.channel !== guild.members.me.voice.channel) {
    return "🚫 kamu haurs di channel voice yang sama";
  }
